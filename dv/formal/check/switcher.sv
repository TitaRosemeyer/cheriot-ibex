...
module tita;
    ...
    module instructions;
        ...
        `CAP_NO_OVERLAP_REGS_FN(no_overlap_except2_fn, i != 2)
        `CAP_NO_OVERLAP_REGS_FN(no_overlap_except2_7_1_fn, (i != 2) && (i != 7) && (i != 1))
        ...
        `define INSTR_WB_LINE(i) `INSTR_WB(instr_lines[i])

        property test_prop;
            (
            PCCHasASR && wbexc_exists && ~wbexc_fetch_err &&
            `INSTR == 32'h03d1005b && // l0 instruction
            ~instr_will_progress
            |-> $past(ibex_top_i.u_ibex_core.id_stage_i.decoder_i.instr_rdata_i == 32'h03d1005b)
            );
        endproperty
        test: assert property (test_prop);
        ...
        property lines_0_1_prop;
            (((PCCHasASR && csp_assumptions && `INSTR_WB_LINE(0)) and
            `INSTR_LIFECYCLE)
            ##1
            (`INSTR_WB_LINE(1) and
        ...
        property lines_0_1_concrete_prop;
            (
            (PCCHasASR && csp_assumptions) and
            (csp_at_entry_no_memory_overlap throughout
            (
            (`INSTR_WB_LINE(0) and `INSTR_DELAY(1))
            ##1
            (`INSTR_WB_LINE(1) and (instr_will_progress))
            ))
            |-> mtdc == csp_at_entry && mtdc_addr == csp_addr_at_entry 
            ##1 ~overlap($past(csp_at_entry), $past(csp_addr_at_entry), ct2, ct2_addr)
            );
        endproperty
        lines_0_1_concrete: assert property (lines_0_1_concrete_prop);
        ...
        property lines_0_2_prop;
            ...
            (csp_at_entry_no_memory_overlap throughout `INSTR_LIFECYCLE))
            ##1
            (`INSTR_WB_LINE(2) and `INSTR_LIFECYCLE)
            |-> mtdc == csp_at_entry && mtdc_addr == csp_addr_at_entry 
        ...
        property lines_0_2_concrete_prop;
            (
            (PCCHasASR && csp_assumptions) and
            (csp_at_entry_no_memory_overlap throughout
            (
            ...
            (`INSTR_WB_LINE(1) and (instr_will_progress))
            ##1
            (`INSTR_WB_LINE(2) and `INSTR_DELAY(1))
            ))
            |-> mtdc == csp_at_entry && mtdc_addr == csp_addr_at_entry 
            ##1 ~overlap($past(csp_at_entry), $past(csp_addr_at_entry), ct2, ct2_addr)
            );
        endproperty
        lines_0_2_concrete: assert property (lines_0_2_concrete_prop);
        ...
        property lines_0_3_prop;
            ...
            (`INSTR_WB_LINE(2) and `INSTR_LIFECYCLE)
            ##1
            (`INSTR_WB_LINE(3) and `INSTR_LIFECYCLE)
            |-> mtdc == csp_at_entry && mtdc_addr == csp_addr_at_entry 
            && ~overlap(csp_at_entry, csp_addr_at_entry, ct2, ct2_addr)
            );
        endproperty
        ...
        property lines_0_3_concrete_prop;
            ...
            (`INSTR_WB_LINE(2) and `INSTR_DELAY(1))
            ##1
            (`INSTR_WB_LINE(3) and `INSTR_DELAY(2))
            ))
            |-> mtdc == csp_at_entry && mtdc_addr == csp_addr_at_entry 
            ##1 ~overlap($past(csp_at_entry), $past(csp_addr_at_entry), ct2, ct2_addr)
            );
        ...
        property lines_0_4_concrete_prop;
            (
            (PCCHasASR && csp_assumptions) and
            (csp_at_entry_no_memory_overlap throughout
            (
            ...
            (`INSTR_WB_LINE(3) and `INSTR_DELAY(2))
            ##1
            (`INSTR_WB_LINE(4) and `INSTR_DELAY(1))
            ))
            |-> mtdc == csp_at_entry && mtdc_addr == csp_addr_at_entry
            ##1 ~overlap($past(csp_at_entry), $past(csp_addr_at_entry), ct2, ct2_addr)
            );
        endproperty
        lines_0_4_concrete: assert property (lines_0_4_concrete_prop);  

        property lines_0_5_concrete_prop;
            (
            (PCCHasASR && csp_assumptions) and
            (csp_at_entry_no_memory_overlap throughout
            (
            ...
            (`INSTR_WB_LINE(4) and `INSTR_DELAY(1))
            ##1
            (`INSTR_WB_LINE(5) and `INSTR_DELAY(1))
            ))
            |-> mtdc == csp_at_entry && mtdc_addr == csp_addr_at_entry
            ##1 ~overlap($past(csp_at_entry), $past(csp_addr_at_entry), ct2, ct2_addr)
        ...
        endproperty
        lines_0_5_concrete: assert property (lines_0_5_concrete_prop);

        property lines_0_6_concrete_prop;
            (
            (PCCHasASR && csp_assumptions) and
            (csp_at_entry_no_memory_overlap throughout
            (
            ...
            (`INSTR_WB_LINE(5) and `INSTR_DELAY(1))
            ##1
            (`INSTR_WB_LINE(6) and `INSTR_DELAY(1))
            ))
            |-> mtdc == csp_at_entry && mtdc_addr == csp_addr_at_entry
            ##1 ~overlap($past(csp_at_entry), $past(csp_addr_at_entry), ct2, ct2_addr)
            && ~overlap($past(csp_at_entry), $past(csp_addr_at_entry), cra, cra_addr)
        ...
        endproperty
        lines_0_6_concrete: assert property (lines_0_6_concrete_prop);
        ...
        property all_lines_concrete_delay_prop;
            ...
            (`INSTR_WB_LINE(6) and `INSTR_DELAY(1))
            ##1
            (`INSTR_WB_LINE(7) and (instr_will_progress))
            ))
            |-> mtdc == csp_at_entry && mtdc_addr == csp_addr_at_entry 
        ...
        property lines_0_7_concrete_prop;
            (
            (PCCHasASR && csp_assumptions && no_overlap_except2_7_1_fn(csp, csp_addr)) and
            (csp_at_entry_no_memory_overlap throughout
            (
            (`INSTR_WB_LINE(0) and `INSTR_DELAY(1))
            ##1
            ...
            |-> mtdc == csp_at_entry && mtdc_addr == csp_addr_at_entry 
            ##1 no_overlap_all_fn($past(csp_at_entry), $past(csp_addr_at_entry))
            );
        endproperty
        lines_0_7_concrete: assert property (lines_0_7_concrete_prop);
